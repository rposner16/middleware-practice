...
function gateKeeper(req, res, next) {
  const headerInit = req.get('x-username-and-password');
  const parsed = queryString.parse(headerInit);
  const matchedUser = USERS.find(function(element) {
     return element.userName === parsed.user;
  });
